/** Reference templates for future WhatsApp retention jobs (cron + queue). Master prompt § retention. */
export const RETENTION_TRIGGERS = [
  ...
  },
  {
    ...
    delay: "45d",
    template: "We’d love to see you again at {businessName}! Book in one tap: {link}",
  },
] as const;
